...
{
  BUILDROOT=/var/cache
  BUILDFOLDERNAME=VTLESS_Build_Files

  export BUILDUNIXNAME=vtless
  export BUILDFRIENDLYNAME=VTless
  ...
  STORAGESIZE_SRCBUILD=$((5 * $GIGABYTE ))
}
